...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Treatment</strong></div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-9 order-2">
            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="float-md-left mb-4"><h2 class="text-black h5">Treatment All</h2></div>
                <div class="d-flex">
              ...
              <div class="col-sm-6 col-lg-4 mb-4">
                <div class="block-4 text-center border">
                  ...
                  <div class="block-4-text p-4">
                    ...
                    <p><a href="/carts" class="buy-now btn btn-sm btn-primary">Add To Cart</a></p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 mb-4" >
